...
> The canonical Morpheus decentralized AI agent

## Overview

Morpheus Claw is a flavor of the [EverClaw](https://everclaw.xyz) decentralized AI agent ecosystem, powered by Morpheus Network inference.
...
This flavor provides the common Morpheus infrastructure (wallet, proxy, session management, security) with a persona and configuration tailored for: The canonical Morpheus decentralized AI agent.

## Installation

```bash
curl -sSL https://morpheusclaw.com/install.sh | bash
```

Or clone and set up manually:

```bash
git clone https://github.com/profbernardoj/morpheusclaw.com.git
cd morpheusclaw.com
npm install
